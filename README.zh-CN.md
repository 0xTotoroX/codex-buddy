...
工作台有三种主要形态：紧凑胶囊、聊天内展开、独立窗口。聊天内展开可固定在右侧或自由移动；收起及空间不足时都回到胶囊，释放侧栏占位，单击按上次位置重新展开。上下、左右、标签和专注只改变内部排布。顶部按钮与刷新在对应标题区域悬停或键盘聚焦时显现，触屏保持可见。
