...
展开外壳统一使用工作台，胶囊仅为紧凑形态；layoutMode 保留原位置偏好，不再选择另一套展开外壳。公共表情使用与胶囊相同模板/状态，在分栏、标签、专注和设置中常驻；紧凑表情单击展开，展开表情双击仅负责弹出/收回，收起走明确入口。浮窗自身的位置/置顶/外观写入串行并及时更新修订号，保留真正外部并发冲突保护。
